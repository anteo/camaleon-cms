...
$ ->
  ...
  $.fn.upload_filemanager = (args)->
    args = args || {}
    open_modal({title: args["title"] || I18n("msg.media_title"), id: 'cama_modal_file_uploader', modal_size: "modal-lg", mode: "ajax", url: root_url+"/#{PluginRoutes.system_info['admin_path_name']}/media/ajax", ajax_params: {media_formats: args["formats"], dimension: args["dimension"] }, callback: (modal)->
      if args["selected"]
